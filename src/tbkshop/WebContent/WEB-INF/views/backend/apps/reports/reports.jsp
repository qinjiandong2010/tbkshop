...
<head>
<title><fmt:message key="report.user_statistic_title"/></title>
...
<body>
		...
		<div class="container">
			<div id="content">
				...
				<div class="right_content">
					<div id="content">
					<h3><fmt:message key="report.user_statistic_title"/></h3>
					<div id="settings">
					...
					<div id="chart-container">
					  ...
					  <div id="report-type-help" class="report-overlay">
                        ...
                        <ul><fmt:message key="report.userstatistic.answer_with_report_type"/></ul>
					    <h4><fmt:message key="report.question_with_nodata"/></h4>
					    <p><fmt:message key="report.answer_with_nodata"/></p>
					  </div>
					  <div id="links"></div>
					  <div id="exports">
	...
	<jsp:include page="../../includes/footer.jsp">
       <jsp:param value="page/reports_app_user" name="loader"/>
    </jsp:include>
</body>
</html>
