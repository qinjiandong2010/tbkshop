	...
	<div class="row-fluid">
		<div class="span12">
			...
			<ul class="breadcrumb">
				...
				<li><a href="javascript;,">商品分类列表</a> <span class="divider">&nbsp;</span></li>
			</ul>
		</div>
	</div>
							...
							<tbody>
								<c:forEach items="${categoryList}" var="item" varStatus="stat">
					            		<tr class="gradeX ${(stat.index%2) == 0 ? 'odd':'even' }">
					                        ...
					                        <td class=" ">
					                        	<a href="/admin/product/category/${item.id }/edit.html">编辑</a>
					                        	<a href="javascript:void(0)" onclick="deleteData('/admin/product/category/${item.id }/delete.html')">删除</a>
					                        </td>
					                    </tr>
					           </c:forEach>
							</tbody>
