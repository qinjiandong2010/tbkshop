...
<body>
	<ul class="breadcrumb">
		...
		<li><a href="#">添加厂商</a><span class="divider-last">&nbsp;</span></li>
	</ul>
		...
		<form:form commandName="companyForm" method="POST" class="form-horizontal form-wizard">
			...
			<div class="widget-content no-padding">
			    ...
			    <div class="form-row">
					...
					<div class="field">
						<div class="input-prepend input-append">
							<form:textarea path="description" class="span12" cols="60" rows="6"/>
						</div>
						<form:errors path="description" cssClass="error"/>
					</div>
				</div>
				<div class="form-row" style="padding-left: 180px;">
					<button type="submit" class="button button-blue">添加厂商</button>
				</div>
			</div>
		</form:form>
	</div>
