		...
		<form:form commandName="categoryForm" method="POST" class="form-horizontal form-wizard">
			...
			<div class="widget-content no-padding">
			    ...
			    <div class="form-row">
					...
					<div class="field">
					    <form:select path="parent" class="chosen" tabindex="-1">
				...
				<div class="form-row">
					...
					<div class="field">
						<div class="input-prepend input-append">
							<form:input path="orderNo" class="span12" maxlength="20" value="0"/> 
						</div>
				...
				<div class="form-row">
                    ...
                    <div class="field">
                        <input type="checkbox" name="visible" class="toggle" checked="checked" value="true"/>
                    </div>
                </div>
