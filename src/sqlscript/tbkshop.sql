...
INSERT INTO `t_category` VALUES (26,'手机数码','',0,1,0),(27,'家纺/家居','',0,1,0),(28,'手机','',26,1,0),(29,'电脑','',26,1,0),(30,'相机','',26,1,0),(31,'影音','',26,1,0),(32,'配件','',26,1,0),(33,'话费点卡','',26,1,0),(34,'汽车配件','',26,1,0),(35,'服装饰品','',0,1,0),(36,'连衣裙','',35,1,0),(37,'平底鞋','',35,1,0),(38,'品牌女装','',35,1,0);
...
CREATE TABLE `t_goods` (
  ...
  `goods_cate` int(11) DEFAULT NULL COMMENT '商品分类',
  `short_into` varchar(255) DEFAULT NULL COMMENT '概要描述',
  `goods_into` text COMMENT '商品介绍',
