...
function removeData(obj,id,pk) {
	...
	$.ajax({
		url: APP + '/Admin/' + CURR_MODULE + '/remove',
		//url: URL+"/remove";
		type:"POST",
		cache: false,
		data:query,
